...
public class NearbyRestaurants {
    ...
    public NearbyRestaurants(final Context ctx, String area, String lat, String lon, final RecyclerView rvList, final Activity activity, final GetResponse gr) {
        this.ctx = ctx;
        this.Area = area;
        this.Lat = lat;
        this.Lon = lon;
        ...
        JsonObjectRequest jsonObjectRequest2 = new JsonObjectRequest("https://developers.zomato.com/api/v2.1/geocode?user-key=9b71538cb6d3419677ab58e98d85cfd6&lat=" + lat + "&lon=" + lon,
                null,
